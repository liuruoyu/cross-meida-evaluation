...
for i = 1:length(results)
    ...
    try
        for j = 1:settings.iterN
            ...
            [MAPi2t1,~,resi2t1] = mAPEvaluate(CCAi_te1(:,1:COMPS),CCAt_tr1(:,1:COMPS),gnd_te1,gnd_tr1,num_tr1,'cosine');
            [MAPt2i1,~,rest2i1] = mAPEvaluate(CCAt_te1(:,1:COMPS),CCAi_tr1(:,1:COMPS),gnd_te1,gnd_tr1,num_tr1,'cosine');
            [MAPi2t2,~,resi2t2] = mAPEvaluate(CCAi_te2(:,1:COMPS),CCAt_tr2(:,1:COMPS),gnd_te2,gnd_tr2,num_tr2,'cosine');
            [MAPt2i2,~,rest2i2] = mAPEvaluate(CCAt_te2(:,1:COMPS),CCAi_tr2(:,1:COMPS),gnd_te2,gnd_tr2,num_tr2,'cosine');
