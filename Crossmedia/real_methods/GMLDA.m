function results = GMLDA(settings)
...
for i = 1:length(results)
    ...
    try
        for j = 1:settings.iterN
            ...
            LDAi_tr1 = ifea_tr1*Wout{1}.Bases;
            LDAt_tr1 = tfea_tr1*Wout{2}.Bases;
            LDAi_te1 = ifea_te1*Wout{1}.Bases;
            LDAt_te1 = tfea_te1*Wout{2}.Bases;
            LDAi_tr2 = ifea_tr2*Wout{1}.Bases;
            LDAt_tr2 = tfea_tr2*Wout{2}.Bases;
            LDAi_te2 = ifea_te2*Wout{1}.Bases;
            LDAt_te2 = tfea_te2*Wout{2}.Bases;
            
            num_tr1 = size(ifea_tr1,1);
            num_tr2 = size(ifea_tr2,1);
            
            [MAPi2t1,~,resi2t1] = mAPEvaluate(LDAi_te1,LDAt_tr1,gnd_te1,gnd_tr1,num_tr1,'cosine');
            [MAPt2i1,~,rest2i1] = mAPEvaluate(LDAt_te1,LDAi_tr1,gnd_te1,gnd_tr1,num_tr1,'cosine');
            [MAPi2t2,~,resi2t2] = mAPEvaluate(LDAi_te2,LDAt_tr2,gnd_te2,gnd_tr2,num_tr2,'cosine');
            [MAPt2i2,~,rest2i2] = mAPEvaluate(LDAt_te2,LDAi_tr2,gnd_te2,gnd_tr2,num_tr2,'cosine');
