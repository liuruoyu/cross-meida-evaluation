function results = GMMFA(settings)
...
for i = 1:length(results)
    ...
    try
        for j = 1:settings.iterN
            ...
            MFAi_tr1 = ifea_tr1*Wout{1}.Bases;
            MFAt_tr1 = tfea_tr1*Wout{2}.Bases;
            MFAi_te1 = ifea_te1*Wout{1}.Bases;
            MFAt_te1 = tfea_te1*Wout{2}.Bases;
            MFAi_tr2 = ifea_tr2*Wout{1}.Bases;
            MFAt_tr2 = tfea_tr2*Wout{2}.Bases;
            MFAi_te2 = ifea_te2*Wout{1}.Bases;
            MFAt_te2 = tfea_te2*Wout{2}.Bases;
            
            num_tr1 = size(ifea_tr1,1);
            num_tr2 = size(ifea_tr2,1);
            
            [MAPi2t1,~,resi2t1] = mAPEvaluate(MFAi_te1,MFAt_tr1,gnd_te1,gnd_tr1,num_tr1,'cosine');
            [MAPt2i1,~,rest2i1] = mAPEvaluate(MFAt_te1,MFAi_tr1,gnd_te1,gnd_tr1,num_tr1,'cosine');
            [MAPi2t2,~,resi2t2] = mAPEvaluate(MFAi_te2,MFAt_tr2,gnd_te2,gnd_tr2,num_tr2,'cosine');
            [MAPt2i2,~,rest2i2] = mAPEvaluate(MFAt_te2,MFAi_tr2,gnd_te2,gnd_tr2,num_tr2,'cosine');
