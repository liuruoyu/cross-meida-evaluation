...
for i = 1:length(results)
    ...
    try
        for j = 1:settings.iterN
            ...
            PLSi_tr1 = ifea_tr1*Wout{1}.Bases;
            PLSt_tr1 = tfea_tr1*Wout{2}.Bases;
            PLSi_te1 = ifea_te1*Wout{1}.Bases;
            PLSt_te1 = tfea_te1*Wout{2}.Bases;
            PLSi_tr2 = ifea_tr2*Wout{1}.Bases;
            PLSt_tr2 = tfea_tr2*Wout{2}.Bases;
            PLSi_te2 = ifea_te2*Wout{1}.Bases;
            PLSt_te2 = tfea_te2*Wout{2}.Bases;
            
            num_tr1 = size(ifea_tr1,1);
            num_tr2 = size(ifea_tr2,1);
            
            [MAPi2t1,~,resi2t1] = mAPEvaluate(PLSi_te1,PLSt_tr1,gnd_te1,gnd_tr1,num_tr1,'cosine');
            [MAPt2i1,~,rest2i1] = mAPEvaluate(PLSt_te1,PLSi_tr1,gnd_te1,gnd_tr1,num_tr1,'cosine');
            [MAPi2t2,~,resi2t2] = mAPEvaluate(PLSi_te2,PLSt_tr2,gnd_te2,gnd_tr2,num_tr2,'cosine');
            [MAPt2i2,~,rest2i2] = mAPEvaluate(PLSt_te2,PLSi_tr2,gnd_te2,gnd_tr2,num_tr2,'cosine');
